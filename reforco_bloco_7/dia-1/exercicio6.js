...
*             Sua função deverá procurar pela letra x em uma string qualquer que você determinar e
*                 substituir pela string que você passou como parâmetro.
...
const arrayOfSkills = ['JavaScript', 'HTML', 'CSS', 'HOF', 'Jest'];

function string (name) { 
  const resultString = nameIndex => `Tryber ${nameIndex} aqui!`;

  let result = `${resultString(name)} Minhas cinco principais habilidades são:`;
