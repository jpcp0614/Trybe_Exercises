...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contendo os valores esperados', () => {
    ...
    // Teste que a função retorna, dentro de um objeto, o comprimento da circunferência correta para um círculo de raio 2.
    expect(Number(parseFloat(circle(2).circumference).toPrecision(4))).toBe(2 * 3.14 * 2);
